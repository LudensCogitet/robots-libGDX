...
public class RobotsMainScreen implements Screen {
	...
	RobotsMainScreen(RobotsGame gameReference) {
	...
	public void render (float delta) {
		...
		if(wouldMove != null) {
			drawPlayerSpecter(game.batch);
		}

		for(RobotsEntity entity : entities) {
			game.batch.draw(sprites[entity.type.sprite], (int) entity.pos.x, (int) entity.pos.y, 1, 1);
		}
